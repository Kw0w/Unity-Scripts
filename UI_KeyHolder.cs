...
public class UI_KeyHolder : MonoBehaviour
{
    ...
    private void UpdateVisual()
    {
        ...
        for (int i = 0; i < keyList.Count; i++)
        {
            ...
            {
                default:
                case Key.KeyType.KeyRed: keyImage.color = Color.red; break;
                case Key.KeyType.KeyGreen: keyImage.color = Color.green; break;
                case Key.KeyType.KeyBlue: keyImage.color = Color.blue; break;
                case Key.KeyType.keyBoss: keyImage.color = Color.yellow; break;
